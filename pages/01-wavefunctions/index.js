...
(Important sidenote: In that graph, unlike the other two, we couldn't describe our knowledge about the system in terms of seperate descriptions of the two particles. TODO: add an explanation of this here. For now, dear reader, just Ctrl-F "Another idea" in the [LessWrong post](http://lesswrong.com/lw/pi/classical_configuration_spaces/).)
...
If you're not comfortable with complex numbers, you might want to take this opportunity to go learn about them [here](https://betterexplained.com/articles/a-visual-intuitive-guide-to-imaginary-numbers/). That said, complex numbers don't actually come up that much in the rest of this series, so even if you're not great at them you'll be okay. (They're much more important for the rest of quantum mechanics than for the narrow slice of it that we're covering. The reason for this will be explained in the post on ground states.)
